...
(function($) {
   ...
   $.fn.tooltip = function(settings) {
     ...
     if (settings == "show") _show(this);
     if (settings == "hide") _hide(this);
     /**
     ...
     function _show(target_elm) {
       ...
       this.dialog_box = this.dialog_box || _create(dialog_content);
       ...
       if (1) {
           position = { 
             start : { 
               left : target_elm_position.left - 515,
               top  : target_elm_position.top - config.arrow_top_offset - 15
             },
             end : {
               left : target_elm_position.left - 315,
               top  : target_elm_position.top  - config.arrow_top_offset - 15
             },
     ...
     function _hide(target_elm) {
       $("body").find("div.jquery-gdakram-tooltip").hide();
     };
     ...
     function _create(content_elm) {
       ...
       var el = $("<div class='jquery-gdakram-tooltip'>\
       ...
       $(content_elm).insertAfter(el.find('.content h1'));
       return el;
     };
